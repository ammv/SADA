...
{
    public class PayToCounteragentListViewModel : TabObservableObjectList<CarPaymentToCounteragent>
    {
        #region Fields
        ...
        public PayToCounteragentListViewModel(IDialogService dialogService, ITabService tabService): 
            base(dialogService, tabService, TypeWrapper<TabObservableObjectForm<CarPaymentToCounteragent>>.Make<PayToCounteragentViewModel>())
        {
        ...
        protected override void _SearchCommand()
        {
            ...
            try
            {
                Entities = new ObservableCollection<CarPaymentToCounteragent>(
                _currentQuery
                .Where(_baseFilter)
                .ToList());
            }
        ...
        protected override void LoadedInner()
        {
            try
            {
                ...
                _defaultQuery = JoinBaseQuery(_ctx.CarPaymentToCounteragent);

                Entities = new ObservableCollection<CarPaymentToCounteragent>(_defaultQuery.Take(_dataCountPerPage).ToList());
        ...
        protected override IQueryable<CarPaymentToCounteragent> JoinBaseQuery(IQueryable<CarPaymentToCounteragent> query)
        {
            return query
                .Include(c => c.Car)
        ...
        public sealed class PayToCounteragentFilter : EntityFilterBase<CarPaymentToCounteragent>
        {
            ...
            public override Expression<Func<CarPaymentToCounteragent, bool>> MakeFilter()
            {
